  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center md:min-h-[27vh] text-gray-200 justify-center space-y-4">
        ...
        <p>If you have any inquiries feedback or need help with your orders please don not hesitate to reach out.</p>
        ...
        <p>If you are looking to get in touch with specific writers, feel free to browse their books or check back for direct contact options.</p>
      </div>
    </div>
  );
}
